...
// BEGIN CUT HERE
    public static void main(String[] args) {
        try {
            eq(0,(new LittleElephantAndSubset()).getNumber(3),7);
            eq(1,(new LittleElephantAndSubset()).getNumber(10),767);
            eq(2,(new LittleElephantAndSubset()).getNumber(47),25775);
            eq(3,(new LittleElephantAndSubset()).getNumber(4777447),66437071);
        } catch( Exception exx) {
